...
class TransactionController:
    ...
    def edit_transaction(self):
        ...
        while True:
            ...
            try:
                new_category = TransactionValidator.validate_category(
                    new_category) if new_category else original_transaction.category
                break
            except ValueError as e:
                print(e)
        ...
        while True:
            ...
            try:
                new_amount = TransactionValidator.validate_amount(
                    amount_str) if amount_str else original_transaction.amount
                break
            except ValueError as e:
                print(e)
        ...
        while True:
            ...
            try:
                new_description = TransactionValidator.validate_description(
                    new_description) if new_description else original_transaction.description
                break
            except ValueError as e:
                print(e)
